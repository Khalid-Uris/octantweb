...
<body id="kt_body"
                        ...
                        <ul class="menu-nav">
                            ...
                            <li class="menu-item menu-item-active" aria-haspopup="true">
                                <a href="{{ route('dashboard.index') }}" class="menu-link">
                                    <span class="svg-icon svg-icon-primary svg-icon-2x menu-icon"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\keen\theme\demo1\dist/../src/media/svg/icons\Home\Home.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24"/>
                            ...
                            <li class="menu-item " aria-haspopup="true">
                                <a href="{{ route('loan.show') }}" class="menu-link">
                                    <span class="svg-icon svg-icon-primary svg-icon-2x menu-icon">
                                        <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\keen\theme\demo1\dist/../src/media/svg/icons\Code\Plus.svg--><svg
                                    ...
                                    <span class="menu-text">Add Loan</span>
                                </a>
                            </li>
                            {{-- Borrower --}}
                            <li class="menu-item " aria-haspopup="true">
                                <a href="{{ route('borrowers.show') }}" class="menu-link">
                                    <span class="svg-icon svg-icon-primary svg-icon-2x menu-icon">
                                        <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\keen\theme\demo1\dist/../src/media/svg/icons\Text\Menu.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <span class="menu-text">Borrower</span>
                                </a>
                            </li>
                            {{-- Loan type --}}
                            <li class="menu-item " aria-haspopup="true">
                                <a href="{{ route('loan-type.show') }}" class="menu-link">
                                    <span class="svg-icon svg-icon-primary svg-icon-2x menu-icon">
                                        <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\keen\theme\demo1\dist/../src/media/svg/icons\Layout\Layout-top-panel-1.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <span class="menu-text">Loan type</span>
                                </a>
                            </li>

                            {{-- Credit Union --}}
                            <li class="menu-item " aria-haspopup="true">
                                <a href="{{ route('credit-union.show') }}" class="menu-link">
                                    <span class="svg-icon svg-icon-primary svg-icon-2x menu-icon">
                                        <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\keen\theme\demo1\dist/../src/media/svg/icons\Files\Folder-check.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <span class="menu-text">Credit Union</span>
                                </a>
                            </li>
                            {{-- User --}}
                            <li class="menu-item " aria-haspopup="true">
                                <a href="{{ route('credit-union.show') }}" class="menu-link">
                                    <span class="svg-icon svg-icon-primary svg-icon-2x menu-icon"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\keen\theme\demo1\dist/../src/media/svg/icons\General\User.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <polygon points="0 0 24 0 24 24 0 24"/>
                            ...
                            {{-- Archives --}}
                            <li class="menu-item " aria-haspopup="true">
                                <a href="{{ route('loan.archivedLoanShow') }}" class="menu-link">
                                    <span class="svg-icon svg-icon-primary svg-icon-2x menu-icon">
                                        <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\keen\theme\demo1\dist/../src/media/svg/icons\Communication\Archive.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            {{-- Account Setting --}}
                            <li class="menu-item " aria-haspopup="true">
                                <a href="{{ route('setting.editSetting') }}" class="menu-link">
                                    <span class="svg-icon svg-icon-primary svg-icon-2x menu-icon">
                                        <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\keen\theme\demo1\dist/../src/media/svg/icons\General\Settings-2.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <li class="menu-item " aria-haspopup="true">
                                <a href="{{ route('user.logout') }}" class="menu-link">
                                    <span class="svg-icon svg-icon-primary svg-icon-2x menu-icon">
                                        <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\keen\theme\demo1\dist/../src/media/svg/icons\Navigation\Sign-out.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <div class="topbar">
                            ...
                            <div class="topbar-item ml-4">
                                <div class="btn btn-icon btn-light-primary h-40px w-40px p-0" id="kt_quick_user_toggle">
                                    {{-- session()->get('name') --}}
                                    <img src="{{ URL::asset(session('image')) }}" class="h-30px align-self-end"
                                        alt="" />
                                </div>
                                <!--
                ...
                <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="#" target="_blank" class="text-dark-75 text-hover-primary">Octant Pipeline</a>
                        </div>
                        <!--end::Copyright-->
                    </div>
                    <!--end::Container-->
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    ...
                    <div class="symbol-label" style="background-image:url({{ URL::asset(session('image')) }})">
                    </div>
                    <i class="symbol-badge bg-success"></i>
                </div>
                <div class="d-flex flex-column">
                    <a href="#"
                        class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ session('first_name') . ' ' . session('last_name') }}</a>
            ...
            <div class="navi navi-spacer-x-0 p-0">
                <!--begin::Item-->
                <a href="{{ route('setting.editSetting') }}" class="navi-item">
                    <div class="navi-link">
                        ...
                        <div class="navi-text">
                            ...
                            <div class="text-muted">Profile Setting
                            ...
                            <div class="timeline-items">
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-info h-100">
                                        ...
                                        <p class="font-weight-normal text-dark-50 pb-2">Many desktop publishing
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-info">
                                        ...
                                        <p class="font-weight-normal text-dark-50 pt-1 pb-2">To start a blog, think of
                    ...
                    <div class="mb-5">
                        ...
                        <div class="d-flex align-items-center mb-6">
                            ...
                            <div class="symbol symbol-35 flex-shrink-0 mr-3">
                                <img alt="Pic" src="{{ asset('assets/media/users/100_5.jpg') }}" />
                            </div>
                            <!--end::Symbol-->
                            <!--begin::Content-->
                ...
                <div class="tab-pane fade pt-3 pr-5 mr-n5" id="kt_quick_panel_settings" role="tabpanel">
                    <form class="form">
                        ...
                        <div class="pt-1">
                            ...
                            <!--begin::Group-->
                            <div class="text-muted">After you log in, you will be asked for additional information
    ...
    <!--end::Page Vendors-->
    <!--begin::Page Scripts(used by this page)-->
    <script src="{{ asset('assets/js/pages/features/forms/editors/tinymce.js') }}"></script>
    ...
    <!--end::Page Vendors-->
    <!--begin::Page Scripts(used by this page)-->
    <script src=" {{ asset('assets/js/pages/features/datatables/basic/paginations.js') }}"></script>
    <!--end::Page Scripts-->
    {{-- tableEnd --}}
    <script>
        var KTAppSettings = {
